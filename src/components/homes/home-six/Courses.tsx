            ...
            <div key={item.id} className="col-xl-3 col-lg-4 col-md-6">
              <div className="courses__item-seven">
                <div className="courses__item-thumb-six">
                  ...
                  <Link href="/course-details" className="courses__wishlist-two"><InjectableSvg src="/assets/img/icons/heart02.svg" alt="" className="injectable" /></Link>
                  <Link href="/courses" className="courses__item-tag-three">{item.country}</Link>
                ...
                <div className="courses__item-content-six">
                  <div className="courses__item-content-six-top">
                    <h2 className="title"><Link href="/course-details">{item.tag}</Link></h2>
